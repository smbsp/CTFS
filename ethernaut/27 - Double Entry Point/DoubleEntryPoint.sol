...
// This is a common function to retrieve tokens stuck in a contract. The CryptoVault operates
// with an underlying token that can't be swept, being it an important core's logic component of the CryptoVault,
...
// Forta is a decentralized, community-based monitoring network to detect threats and anomalies on DeFi,
// NFT, governance, bridges and other Web3 systems as quickly as possible. Your job is to implement
// a detection bot and register it in the Forta contract. The bot's implementation will need to raise
// correct alerts to prevent potential attacks or bug exploits.
